 ...
 * Allow/Deny buttons, plugin widgets, or the transparent background, which all sit
 * outside `.pet`. Because it tests the rendered `.pet` element, the boundary follows
 * the actual pet at any scale or imported-sprite height.
 */
