...
contextBridge.exposeInMainWorld("companion", {
  ...
  startPetDrag: () => ipcRenderer.invoke("companion:pet-drag-start"),
  movePetDrag: () => ipcRenderer.invoke("companion:pet-drag-move"),
  endPetDrag: () => ipcRenderer.invoke("companion:pet-drag-end"),
